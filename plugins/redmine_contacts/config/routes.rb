#custom routes for this plugin
  ...
  match 'projects/:project_id/sale_funel'  => 'sale_funel#index'
  match 'sale_funel/:action' => 'sale_funel#index'

  match 'notes/:note_id' => 'notes#show', :via => :get
  ...
  match 'notes/:note_id/destroy_note' => 'notes#destroy_note'
